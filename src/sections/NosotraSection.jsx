    ...
    >
      ...
      <CardBody className="">
        ...
        <Typography variant="lead" className="text-darkBlue text-2xl mb-3">
          ...
          Públicas recibidas de la UBA, donde además de estudiar, nos conocimos.
        </Typography>
        <Typography variant="lead" className="text-darkBlue text-2xl">
          Nos dicen Tati y Sil y este proyecto inició como una idea allá por el
          2017 en una clase de impuestos, nos miramos y dijimos tenemos que
        ...
        <Typography variant="lead" className="text-darkBlue text-2xl">
          Gracias a nuestro trabajo, experiencia y trayectoria, estamos seguras
          de que podemos acercate la tranquilidad y seguridad impositiva que tu
          proyecto necesita. Hoy acompañamos a emprendimientos y empresas en su
          crecimiento, generando solvencia y durabilidad en su desarrollo y su
          economía.
        </Typography>
        <Typography variant="h5" className="text-darkBlue my-3 text-2xl">
