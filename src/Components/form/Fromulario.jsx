...
const Formulario = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (nombre.trim() === '' || !validarNombre(nombre)) {
      erroresActuales.nombre = 'El nombre es requerido y solo puede contener letras y espacios';
    }
    ...
    if (mensaje.trim() === '') {
      ...
      erroresActuales.mensaje = 'El mensaje no puede tener más de 200 caracteres';
    }
    ...
    <section className='text-gray-600 body-font relative bg-darkBlue' id='contacto'>
      <div className='container px-5 py-24 mx-auto'>
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <form className=" flex flex-wrap -m-2" onSubmit={handleSubmit} noValidate>
                ...
                <div className="p-2 w-full">
                    <div className="relative">
                        ...
                        required 
                        />
                        {errores.subject && <p className="error-message">{errores.subject}</p>}
                    </div>
                </div>
                <div className="p-2 w-full">
                  <div className="relative">
                    ...
                    />
                    {errores.mensaje && <p className="error-message" >{errores.mensaje}</p>}
                  </div>
                </div>
                <Typography>
